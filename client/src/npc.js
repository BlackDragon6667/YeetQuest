...
const NpcTalk = {
    ...
    priest: [
        ...
        "Please stay a while and enjoy the many surprises of DragsLittleTavern",
    ...
    octocat: [
        "Welcome to DragsLittleTavern!",
        "Want to see the source code?",
        'Check out <a target="_blank" href="">the repository on GitHub</a>',
    ],
